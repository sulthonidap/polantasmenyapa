...
import { MapPin, Phone, Youtube, Camera, Shield, FileSpreadsheet, ArrowRight } from 'lucide-react';
      ...
      >
        ...
        <div className="container mx-auto px-12 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Mudik 2025 semakin dekat! Pastikan perjalanan Anda lebih aman, nyaman, dan lancar dengan informasi terkini.
            </motion.p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            >
              <div className="text-blue-600 mb-4 flex gap-2 items-center">
                {item.icon}
        ...
        <div className="bg-blue-900 rounded-2xl p-8 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold">Kontak Darurat</h3>
                <p>110 - Siap melayani 24/7</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p>Info mudik terkini</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <Shield className="h-8 w-8" />
              <div>
                <h3 className="text-xl font-semibold">Lapor Aduan</h3>
                <p>Lalu lintas 24 jam</p>
              </div>
            </div>
          </div>
        </div>
